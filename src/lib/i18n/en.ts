export const en = {
  ...
  "settings.group.noticeDesc": "A line of text at the top of the public site.",
  ...
  "settingsWorkspace.fieldTooLong": "Too long",
  "settingsWorkspace.fieldNotPlainText": "Plain text on one line, without HTML",
  "settingsWorkspace.fieldInvalidLink": "Use a page on this site like /products, or an address starting with https://",
  "settingsWorkspace.fieldInvalidDate": "Pick a date",
  ...
  "registryBrowser.detail.provider": "Provider",
  "registryBrowser.detail.madeBy": "Made by",
  "registryBrowser.detail.terms": "Terms",
  ...
  "registryBrowser.error.notEntitled": "Not activated for this site.",
  "registryBrowser.error.notEntitledWith": "Not activated for this site: {message}",
  "registryBrowser.error.keyInvalid": "The key for {source} no longer works. Check with the provider.",
  "registryBrowser.error.sourceUnreachable": "Couldn't load extensions from {source}.",
  "registryBrowser.paid.once": "one-time",
  "registryBrowser.paid.month": "/ month",
  "registryBrowser.paid.year": "/ year",
  "registryBrowser.paid.contact": "Contact provider",
  "registryBrowser.paid.notActivated": "Not activated",
  "registryBrowser.paid.askProvider": "Ask {host} to activate it for your site.",
  "registryBrowser.paid.updateNeedsAccess": "Ask {host} to activate it to get the new version. The installed version keeps working.",
  "registryBrowser.paid.request": "Request access",
  "registryBrowser.paid.buy": "Buy",
  "registryBrowser.paid.requested": "Requested · {date}",
  "registryBrowser.paid.requestedNoDate": "Requested",
  "registryBrowser.request.title": "Request {name}",
  "registryBrowser.request.intro": "{host} will get your request and contact you to activate it.",
  "registryBrowser.request.note": "Message (optional)",
  "registryBrowser.request.contact": "Include my name and email",
  "registryBrowser.request.cancel": "Cancel",
  "registryBrowser.request.send": "Send",
  "registryBrowser.request.sending": "Sending…",
  "registryBrowser.request.close": "Close",
  "registryBrowser.request.notAccepted": "{host} doesn't take requests here. Contact the provider directly.",
  ...
  "registryBrowser.plugins.otherSourceShort": "Installed from {source}",
  ...
  // ExtraFieldsManager(設定頁)+ ExtraFieldsPanel(編輯頁)
  "extraFields.title": "Additional fields",
  "extraFields.desc": "Fields you add to a content type appear in the editor for every entry of that type.",
  "extraFields.contentType": "Content type",
  "extraFields.noTypes": "No content types yet. Turn on an extension that has content first.",
  "extraFields.empty": "No additional fields for this content type yet.",
  "extraFields.add": "Add field",
  "extraFields.label": "Name",
  "extraFields.labelPlaceholder": "e.g. Notes",
  "extraFields.key": "Key",
  "extraFields.keyPlaceholder": "e.g. notes",
  "extraFields.keyHint": "The key is how your website's code reads the field: a lowercase letter first, then letters, numbers or underscores.",
  "extraFields.fieldType": "Type",
  "extraFields.type.boolean": "Checkbox",
  "extraFields.type.text": "Single-line text",
  "extraFields.type.textarea": "Multi-line text",
  "extraFields.type.number": "Number",
  "extraFields.public": "Public",
  "extraFields.publicHint": "Your website can read public fields. The rest are only visible in the admin.",
  "extraFields.limit": "Up to {n} fields per content type.",
  "extraFields.save": "Save fields",
  "extraFields.saving": "Saving…",
  "extraFields.saved": "Saved",
  "extraFields.unsaved": "Unsaved changes",
  "extraFields.error.label": "Enter a name",
  "extraFields.error.key": "Start with a lowercase letter; letters, numbers and underscores only",
  "extraFields.error.duplicate": "Another field already uses this key",
  "extraFields.fixErrors": "Fix the highlighted fields first.",
  "extraFields.saveFailed": "Couldn't save. Try again.",
  "extraFields.notAllowed": "Only admins can change this.",
